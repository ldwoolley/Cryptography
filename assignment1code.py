...
MSGS = ( 
        'This is a test of the system that converts text to an encrypted string',
...
RealMSG = ( "32510ba9babebbbefd001547a810e67149caee11d945cd7fc81a05e9f85aac650e9052ba6a8cd8257bf14d13e6f0a803b54fde9e77472dbff89d71b57bddef121336cb85ccb8f3315f4b52e301d16e9f52f904" )
...
def main():
    ...
    print( txt for txt in ciphertexts )

def decript():
    #for msg in TestMSGS:
    #    print( msg +"\n")
    key = encrypt(TestMSGS[0], TestMSGS[1])
    print(key)
    ciphertexts = [encrypt(key, msg) for msg in TestMSGS]
    print( txt for txt in ciphertexts )
